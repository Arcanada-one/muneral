...
import { SOLUTION_LOG_HEAD_PROPOSAL_FIELDS, SOLUTION_LOG_HEAD_RECEIPT_FIELDS } from './solution-log-head.types.js';
import type { SolutionLogHeadProposalV0, SolutionLogHeadReceiptV0 } from './solution-log-head.types.js';
